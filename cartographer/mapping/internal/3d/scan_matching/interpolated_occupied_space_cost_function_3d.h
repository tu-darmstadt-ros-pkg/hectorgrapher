...
#ifndef CARTOGRAPHER_MAPPING_INTERNAL_3D_SCAN_MATCHING_INTERPOLATED_OCCUPIED_SPACE_COST_FUNCTION_3D_H_
#define CARTOGRAPHER_MAPPING_INTERNAL_3D_SCAN_MATCHING_INTERPOLATED_OCCUPIED_SPACE_COST_FUNCTION_3D_H_
...
class InterpolatedOccupiedSpaceCostFunction3D {
 public:
  static ceres::CostFunction* CreateAutoDiffCostFunction(
    ...
    return new ceres::AutoDiffCostFunction<
        InterpolatedOccupiedSpaceCostFunction3D, ceres::DYNAMIC /* residuals */,
        3 /* translation variables */, 4 /* rotation variables */,
        3 /* translation variables */, 4 /* rotation variables */>(
        new InterpolatedOccupiedSpaceCostFunction3D(
 ...
 private:
  InterpolatedOccupiedSpaceCostFunction3D(
      const double scaling_factor, const PointCloudType& point_cloud,
      const mapping::HybridGrid& hybrid_grid, const double interpolation_ratio)
  ...
  InterpolatedOccupiedSpaceCostFunction3D(
      const InterpolatedOccupiedSpaceCostFunction3D&) = delete;
  InterpolatedOccupiedSpaceCostFunction3D& operator=(
      const InterpolatedOccupiedSpaceCostFunction3D&) = delete;
