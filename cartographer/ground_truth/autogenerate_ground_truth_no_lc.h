...
#ifndef CARTOGRAPHER_GROUND_TRUTH_AUTOGENERATE_GROUND_TRUTH_NO_LC_H_
#define CARTOGRAPHER_GROUND_TRUTH_AUTOGENERATE_GROUND_TRUTH_NO_LC_H_
...
#endif  // CARTOGRAPHER_GROUND_TRUTH_AUTOGENERATE_GROUND_TRUTH_NO_LC_H
